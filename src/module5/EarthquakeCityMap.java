...
public class EarthquakeCityMap extends PApplet {
	...
	public void mouseClicked()
	{
		if (lastClicked != null) {
			...
			if(ClickedMarker(quakeMarkers)){
				hideCityMarkers( (EarthquakeMarker)lastSelected);
			}
			else if (ClickedMarker(cityMarkers)){
				hideQuakeMarkers(lastSelected);
			}
			else {
	...
	private void hideCityMarkers(EarthquakeMarker LastClicked) {

		for(Marker marker : cityMarkers) {
			if (marker.getDistanceTo(LastClicked.getLocation()) > LastClicked.threatCircle()) {
	...
	private void hideQuakeMarkers(Marker LastClicked) {
